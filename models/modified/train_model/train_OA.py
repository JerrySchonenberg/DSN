...
def get_image_generators(train_dir: str, valid_dir: str, test_dir: str, batch: int):
...
def finetune_model(old_model: str) -> tf.keras.Sequential:
...
def start_training(old_model: str, batch_size: int, epoch_amount: int, dataset: int) -> None:
